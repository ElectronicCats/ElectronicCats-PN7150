...
unsigned char T3T_Check[] =
    {0x10, 0x06, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x01, 0x0B, 0x00, 0x1, 0x80, 0x00};
...
void RW_NDEF_T3T_Read_Next(
    ...
    *pCmd_size = 0;
    ...
    case Getting_AttributeInfo:
        /* Is Check success ?*/
        if((pRsp[Rsp_size - 1] == 0x00) && (pRsp[1] == 0x07) && (pRsp[10] == 0x00) &&
           (pRsp[11] == 0x00)) {
            /* Fill File structure */
        ...
        if((pRsp[Rsp_size - 1] == 0x00) && (pRsp[1] == 0x07) && (pRsp[10] == 0x00) &&
           (pRsp[11] == 0x00)) {
            ...
            if((RW_NDEF_T3T_Ndef.Size - RW_NDEF_T3T_Ndef.Ptr) <= 16) {
                memcpy(
                    &RW_NDEF_T3T_Ndef.p[RW_NDEF_T3T_Ndef.Ptr],
                    &pRsp[13],
